...
public class RoundServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new RoundServiceImpl(orderService, moveOrder, attackOrder, unitUpgradeOrder, techResearchOrder, combatResolutionService, territoryService, unitService, playerService, gameService, territoryViewService);
    }
