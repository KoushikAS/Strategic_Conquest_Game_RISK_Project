...
public class GameTerritory implements Territory, Serializable {
    ...
    public GameTerritory(String name, int unitNum) {
        this.name = name;
        this.owner = null;
    ...
    public boolean equals(Object other) {
        if (other != null && other.getClass().equals(getClass())) {
            GameTerritory otherTerritory = (GameTerritory) other;
            //TODO Add more condition to check the equals.
            if (otherTerritory.getName().equals(this.getName()) && otherTerritory.getUnitNum() == this.unitNum) {
                return true;
            } else {
                return false;
            }
